...
data = pd.read_csv("data/setC.csv", delimiter=',', header=None, names=['x','y'])

pf = pd.read_csv("log/._data_setC_2022-12-05-145335/dso_._data_setC_0_pf.csv", usecols=['complexity','r','expression'])
